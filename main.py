...
async def connect(connection):
    ...
    print("✅ Connected to League of Legends client!")  # Debug print

    # Get the current game mode (queue type)
    try:

        # Get the current lobby game mode
        ...
        print(f"Current game mode in lobby: {game_mode}")  # Display the current game mode in the lobby

    except Exception as e:
        print(f"Error retrieving game modes or lobby info: {e}")
    temp_champions_map = {}
